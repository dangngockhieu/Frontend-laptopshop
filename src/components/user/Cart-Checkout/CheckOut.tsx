...
import { createOrder, createURLPayment, deleteCartItem } from '../../../services/apiServices';
...
const Checkout = () => {
    ...
    { label: "Thanh toán bằng VNPAY", value: "VNPAY" }
    ];
  ...
  try {
    ...
    const orderId = response.data.data;
      ...
      for (const item of items) {
        ...
        if (res?.data?.statusCode < 400) dispatch(removeItem(String(item.id)));
      }
